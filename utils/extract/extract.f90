...
logical :: with_mpcd_atoms
integer :: ifrm_beg, ifrm_end, ifrm_stp, mflag
...
mflag = str_to_i(cla_buf)

call get_command_argument(8, cla_buf)
read(cla_buf,*) with_mpcd_atoms
...
do iframe = ifrm_beg, ifrm_end, ifrm_stp
    ...
    call write_ldf(fn_ldf, 'Frame-'//str_from_num(iframe), with_mpcd_atoms)
end do
