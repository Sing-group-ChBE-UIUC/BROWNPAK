...
! Removed dependence on module `face`. -- Sarit Dutta
...
contains
  ...
  function get_designator(priority) result(des)
    !* Author: Chris MacMackin
    !  Date: December 2016
    !
    !  Removed dependence on the **face** module by removing optional input
    !  `ansi_colours`
